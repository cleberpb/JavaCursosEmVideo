...
public class TelaVoto extends javax.swing.JFrame {
    ...
    private void btnVotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotoActionPerformed
        ...
        int ano = Integer.parseInt(txtAno.getText()); // pega o valor de txtAno
       
        //calcular idade
        int idade = 2022 - ano;
        
        if (idade < 16) {
            lblResultado.setText("Você tem " +idade+ " anos. NÃO VOTA!");
        } else if ((idade >= 16 && idade < 18) || (idade > 70)){
                lblResultado.setText("Você tem "+idade+ " anos. VOTO OPCIONAL!");
        } else if (idade >=70){
                lblResultado.setText("Você tem "+idade+ " anos. VOTO OBRIGATÓRIO!");
        }
